  ...
  <div class="row">
    <div class="container mx-auto pt-16 pb-16">
      <div class="grid grid-cols-1 gap-5 px-1">
        <div
          class="fixed top-14 p-5 left-0 right-0 pl-8 font-bold text-primary text-lg bg-dark-light"
        >
          <div class="flex items-center">
            <i class="t2ico t2ico-wallet"></i>
            <span class="pr-1">Tổng chi tiêu của bạn: </span>
            <span>{{
        ...
        <ul
          ...
          :key="item.id"
          class="rounded-lg bg-blue-50 px-8 py-4 mt-20"
        >
          <li>
            <div class="">
              <span>Ngày tạo: </span>
