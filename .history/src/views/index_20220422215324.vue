<template>
  ...
  <div class="row">
    <div class="container mx-auto p-8">
      ...
      <div
        v-if="user"
        class="flex justify-center items-center font-bold text-2xl text-primary mt-3"
      >
        {{ user.displayName }}
      </div>
      <p
            ...
            <li>
              ...
              >
                <div class="flex items-center text-left">
                  ...
                  <h5 class="font-semibold ml-3">Ví của tôi</h5>
                </div>
...
export default {
  setup() {
    ...
    const PROFILE_OPTIONS = reactive([
      {
        name: "Ví của tôi",
        icon: "t2ico-wallet",
        route: {
