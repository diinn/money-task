          ...
          <div class="container mx-auto px-8">
            <div class="row">
              <label for="location" class="flex items-center">
                ...
                <div
                  class="flex flex-col items-center justify-center flex-1 border-b border-gray-100"
                >
                  <input
                    id="location"
                  ...
                  />
                  <button
                    class="w-28 rounded px-1 bg-primary text-white mt-2"
                    @click="getLocation"
                  >
                    Lấy tọa độ
                  </button>
            ...
            <div class="row">
              ...
              >
                ...
                <div class="relative flex items-center">
                  ...
                  <button
                    v-if="thumbnail"
                    class="absolute top-1 right-1 bg-primary p-1 rounded-full text-white font-bold z-10"
                    @click="delImg"
                  >
                    Xóa
                  </button>
    ...
    function getLocation() {
      try {
        navigator.geolocation.getCurrentPosition(
          (position) => {
            location.value = `Kinh độ: ${position.coords.longitude.toFixed(
              2
            )}, Vĩ độ: ${position.coords.latitude.toFixed(2)}`;
